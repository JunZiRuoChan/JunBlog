<?php
/* Smarty version 3.1.30, created on 2017-06-05 21:53:43
  from "D:\wamp\www\Blog\App\Home\View\Index\blogSearchList.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_59356267b272e0_53726103',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '3ee2d87ef46d7e8f2ae616ac4c10d11767dd576f' => 
    array (
      0 => 'D:\\wamp\\www\\Blog\\App\\Home\\View\\Index\\blogSearchList.html',
      1 => 1496669383,
      2 => 'file',
    ),
  ),
...
function content_59356267b272e0_53726103 (Smarty_Internal_Template $_smarty_tpl) {
...
"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['art']->value['m_number'])===null||$tmp==='' ? 0 : $tmp);?>
                ...
                <div class="column"><span><?php echo smarty_modifier_truncate(smarty_modifier_date_format($_smarty_tpl->tpl_vars['art']->value['a_publishtime'],"%Y-%m-%d"),100);?>
</span></div>
              </div><!-- .post-meta -->
        ...
        <div class="col-lg-3 col-md-4">
          ...
          <aside class="sidebar">
            <section class="widget widget_search">
              <form method="post" class="search-box" action="index.php">
                <input type="hidden" name="a" value="search" />
                
                <input type="text" class="form-control" name="keywords" placeholder="按标题搜索博文">
...
?>
            ...
            <section class="widget widget_recent_posts">
              ...
              <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['three']->value, 'thre');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['thre']->value) {
?>
              <div class="item">
                <div class="thumb">
                  <a href="index.php?m=article&id=<?php echo $_smarty_tpl->tpl_vars['thre']->value['id'];?>
"><img src="Public/<?php echo @constant('PLAT');?>
/img/blog/sidebar/post01.jpg" alt="Post01"></a>
                </div>
                <div class="info">
                  <h4><a href="index.php?m=article&id=<?php echo $_smarty_tpl->tpl_vars['thre']->value['id'];?>
"><?php echo $_smarty_tpl->tpl_vars['thre']->value['a_name'];?>
</a></h4>
                </div>
              </div><!-- .item -->
              <?php
